...
## !DOCTYPE Declaration
- The `<!DOCTYPE>` declaration represents the document type, and helps browsers to display web pages correctly and is not case sensitive
...
```
<img src="imagename.jpg" alt="it is a earth image" width="104" height="142">
...
------------- | -----------------------
	...
	< embed > or <object> instead | Defines an embedded applet
